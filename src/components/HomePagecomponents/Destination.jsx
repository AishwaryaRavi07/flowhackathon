...
import Maldives from "../HomePagecomponents/img/maldives.jpg";
import Beach from "../HomePagecomponents/img/beach.jpg";
import Japan from "../HomePagecomponents/img/japan.jpg";
import NewZealand from "../HomePagecomponents/img/newzealand.jpg";
...
function Destination() {
  return (
    ...
    <div className="card" style={{marginLeft:"30px"}}>
      <div className="card-image">
        <img style={{marginLeft:"19px"}}src={Japan}  />
      </div>
      <div className="card-content">
    ...
    <div className="card-content">
      ...
      <div className="card-image">
        <img style={{marginLeft:"12px",marginTop:"-7vh"}} src={NewZealand}  />
      </div>
